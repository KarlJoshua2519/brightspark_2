...
<body class="bg-gray-100 font-family-karla h-screen">
    ...
    <div class="mt-4 mb-4">
            ...
            <div class="w-full md:w-1/2 flex flex-col">
                ...
                <div class="flex flex-col justify-center md:justify-start my-auto pt-8 md:pt-0 px-8 md:px-24 lg:px-32">
                    ...
                    <form class="flex flex-col pt-3 md:pt-8" method="POST" action="/learners/signin">
                        ...
                        <button type="submit"
                            class="bg-blue-500 text-white font-bold text-lg hover:bg-blue-600 p-2 mt-8"> Log in</button>

                    </form>
                    <div class="text-center pt-12 pb-12">
                        <p>Are you a teacher? <a href="/teacher/login" class="underline font-semibold">Login here</a>
                        </p>
                        <p>Don't have an account? <a href="/student/registration"
        ...
        <div class="w-1/2 shadow-md">
            <img class="object-cover w-full h-screen hidden md:block" src="{{ asset('images/studentlogin.png') }}">
        </div>
    </div>
</div>
    <x-footer />
